...
(function($,w){
	...
	var alertTemplate='<div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button><h4 class="modal-title">@{title}</h4></div><div class="modal-body">'+
	'<p>@{msgContent}</p></div>  <div class="modal-footer"><a role="button" class="btn btn-info JConfirmBtn">确定</a></div>';

	var confirmTemplate='<div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button><h4 class="modal-title">@{title}</h4></div><div class="modal-body">'+
	'<p>@{msgContent}</p></div>  <div class="modal-footer">'+
	'<a role="button" class="btn btn-white JCancelBtn">取消</a><a role="button" class="btn btn-info JConfirmBtn">确定</a></div>';
	$.extend(dialog,{
		...
		fAlert:function(msg,callback){
			var data={title:'提示',msgContent:msg};
