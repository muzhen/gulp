...
(function ($, window, undefined) {
    ...
    $(document).ready(function () {
        ...
        $('a[data-toggle="sidebar"]').each(function (i, el) {
            $(el).on('click', function (ev) {
                ...
                if (public_vars.$sidebarMenu.hasClass('collapsed')) {
                    ...
                    public_vars.$sidebarMenu.addClass('collapsed').find('ul').removeAttr('style')
                    ps_destroy();
                }
        ...
        var SidebarToggleAuto = function (ev) {

            var sidebarMenuFn = function () {
                var $Btn = $('.sidebarMenuBtn');
                if ($Btn.hasClass('on')) {
                    $Btn.removeClass('on');
                    //ps_init();
                }
                    ...
                    $Btn.addClass('on');
                    window.setTimeout(sidebarMenuFn,8000)
                }
