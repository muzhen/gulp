...
(function () {
    ...
    var URL = ctx+"/resource/themes/xenon/assets/js/uEditor/";  //编辑器根目录位置
    /**
    ...
    window.UEDITOR_CONFIG = {
        ...
        , imagePath: URL.replace("/ueditor/", "/") + "net/"                      //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
        ...
        , imageManagerPath: URL.replace("/ueditor/", "/") + "net/"                                    //图片修正地址，同imagePath
        ...
        , toolbars:[
            ['fullscreen', 'source', '|', 'undo', 'redo', '|',
                ...
                'insertimage',  'map', 'template', 'background', '|',
                'horizontal', '|',
