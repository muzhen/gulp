    ...
    $.extend($.validator, {
        ...
        prototype: {
            ...
            showLabel: function (element, message) {
                ...
                var getPlacement = function (pos, targetHeight) {
                    var
                        placement,
                ...
                var placement = getPlacement(elementPos, '0')
                ...
                var postionInfo = getTargetPositin(getElementPosition(), 'right', 100, 32);
                ...
                if (error.length) {
                    ...
                    error = $("<" + this.settings.errorElement + ">")
                        ...
                        .addClass(this.settings.errorClass).css(postionInfo.position)
                        .html(message || "");
                    ...
                    if (this.labelContainer.length) {
                       this.labelContainer.append(place);
                        ...
                        place.css(postionInfo.position)
                    } else if (this.settings.errorPlacement) {
                        this.settings.errorPlacement( place, $( element ) );
                      /* $('body').append(place);*/
                            $("#" + elementID + "-error").css(postionInfo.position)
